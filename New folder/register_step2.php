...
<div class="alert alert-success alert-dismissible" role="alert">
  ...
  <strong>Success!</strong> You are now registered as <b><?php echo $product->username; ?>, </b><a href="index.php">View Data</a>.
</div>
<?php
 }else{
?>
              ...
              <div class="row">
                  ...
                  <div class="col-xs-6">
                      <p>
                          <b>Hello!</b><br>
                          <br>
                          So you have decided to register. <p>Please enter your details as accurate as possible. <p>Then hit submit.</p> 
